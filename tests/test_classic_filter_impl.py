...
class ClassicFilterImplementationTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.image = Image.open(os.path.join(pathlib.Path().resolve(), "..", "tests", "images", "photo3.jpg"))
        self.verticalImage = Image.open(os.path.join(pathlib.Path().resolve(), "..", "tests", "images", "firefox-ailurus-fulgens-malaya.jpg"))
        self.squareImage = Image.open(os.path.join(pathlib.Path().resolve(), "..", "tests", "images", "unnamed.jpg"))
        self.badImage = Image.open(os.path.join(pathlib.Path().resolve(), "..", "tests", "images", "unnamed_2.jpg"))
